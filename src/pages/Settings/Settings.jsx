...
const Settings = ({color, datas_personal, personalChange, personal, setPersonal, is2faEnabled}) => {
    ...
    const VerificationChange = async (e) => {
        ...
        try {
            const newDataName = {
                ...
                lastname: last,
                date_birth: date,
                passport_id: passwordId,
                inn: innData,
                country: countryApp,
                city: city,
                address: address,
                photo_passport: imgPassport,
                photo_address: imgAddress,
            };
            const response = await axios.post(
    ...
    const handle2faGenerate = async () => {
        try {
            setLoading(true);
            const response = await axios.post(url + '/profile/security/2fa/generate/', null, {headers});
            setLoading(false);
